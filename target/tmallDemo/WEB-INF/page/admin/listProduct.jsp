                ...
                <tbody>
                    ...
                    <c:forEach items="${products}" var="product">
                        <tr>
                            ...
                            <td>${product.stock}</td>
                            <td><a><span class="glyphicon glyphicon-picture"></span></a></td>
                            <td><a><span class="glyphicon glyphicon-th-list"></span></a></td>
            ...
            <form id="addForm" method="post" action="admin_product_add.do">
                ...
                <table class="addTable">
                    <tbody style="text-align: left">
                        ...
                        <tr class="submitTR">
                            <!--两列并为一列-->
                            <td colspan="2"><button type="submit" class="btn btn-success">提 交</button></td>
                        </tr>
                    </tbody>
                </table>
            </form>
